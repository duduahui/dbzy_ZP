...
//		TbAdmin admin=(TbAdmin) req.getSession().getAttribute("admin");
	...
	public String editRole(String roleId,String roleName,String roleRemark,HttpServletRequest req) throws UnsupportedEncodingException {
		...
		role.setRoleRemark(new String(roleRemark.getBytes("ISO-8859-1"), "utf-8"));
...
//		}
	 ...
	 */
	@SysLog(value="更新管理员信息")
	@RequestMapping("/updAdmin2")
	@RequiresPermissions("sys:admin:update")
	@ResponseBody
	public ResultUtil updAdmin2(TbAdmin admin) {
		if(admin!=null&&admin.getId()==1){
